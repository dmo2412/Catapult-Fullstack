...
# project2 = Project.create([{title: "11 foot rims"} , {category_id: 6}, {creator_name: 'Michael Jordan'}, {creator_id: 2 }, {funding_goal: 1000000 }, {description: 'Sometimes I\'m too good for a 10 foot hoop'}, {pledged: 50000}, {location: 'United States'}, {close_date: Date.parse('2020-10-04')} ])
